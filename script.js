...
/* =========================
   Datas fixas (GitHub)
   ========================= */
const START_DATE = new Date("2025-08-02T00:00:00");
const NOW = new Date();
...
(function floatingBackgroundPhotos() {
  ...
  imgs.forEach((img, i) => {
    ...
    img.style.opacity = String(0.1 + Math.random() * 0.1);
    if (i % 2 === 1) {
...
function openLetter() {
  ...
  setPaperDate();
  startTyping(18);
  if (toggleLetterBtn) toggleLetterBtn.textContent = "Fechar carta 💌";
  setTimeout(
...
function closeLetter() {
  ...
  setTimeout(() => {
    ...
    if (toggleLetterBtn) toggleLetterBtn.textContent = "Abrir carta 💌";
  }, 1400);
}
